...
import BackButton from "@/components/festivalsystem/singleband/button/BackButton";
...
const SingleBand = ({ band }) => {
  ...
  return (
    <motion.section initial={{ y: "30vh", opacity: 0 }} animate={{ y: "0", opacity: 1 }} exit={{ y: "-30vh", opacity: 0 }} transition={{ duration: 0.5 }}>
