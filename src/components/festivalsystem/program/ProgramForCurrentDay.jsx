    ...
    <motion.section initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 1, delay: 0.3 }} animate={{ y: -40 }}>
      <section className="py-[10vh] px-4 max-w-screen-xl mx-auto">
        ...
        <div>
          <div className="py-6">
            ...
            <div className="flex gap-4 justify-end mt-4">
              <button type="button" aria-label="Left" onClick={() => (scrollContainerRef1.current.scrollLeft -= 200)}>
                <FaArrowLeft className="text-customOrange w-[1.5rem] h-[1.5rem]" />
              </button>
              <button className="" type="button" aria-label="Right" onClick={() => (scrollContainerRef1.current.scrollLeft += 200)}>
          ...
          <div className="py-6">
            ...
            <div className="flex gap-4 justify-end mt-4">
              <button className="" aria-label="Left" onClick={() => (scrollContainerRef2.current.scrollLeft -= 200)}>
                <FaArrowLeft className="text-customOrange w-[1.5rem] h-[1.5rem]" />
              </button>
              <button className="" type="button" aria-label="Right" onClick={() => (scrollContainerRef2.current.scrollLeft += 200)}>
                <FaArrowRight className="text-customOrange w-[1.5rem] h-[1.5rem]" />
              </button>
            </div>
          </div>
          <div className="py-6">
            ...
            <div className="flex gap-4 justify-end mt-4">
              <button type="button" aria-label="Left" onClick={() => (scrollContainerRef3.current.scrollLeft -= 200)}>
                <FaArrowLeft className="text-customOrange w-[1.5rem] h-[1.5rem]" />
              </button>
              <button type="button" aria-label="Right" onClick={() => (scrollContainerRef3.current.scrollLeft += 200)}>
                <FaArrowRight className="text-customOrange w-[1.5rem] h-[1.5rem]" />
              </button>
            </div>
          </div>
        ...
        <div className="grid place-content-center pt-8">
          <Link href="/program">
            <PrimaryButton type="text" aria_label_text="View program for whole week" color="bg-gradient-to-r from-[#ec2783] from-12% via-[#d82023] via-46% to-[#ec4d08] to-87%" buttonContent="Se hele ugens program" />
          </Link>
        </div>
      </section>
    </motion.section>
